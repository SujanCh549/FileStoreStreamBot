...
SESSION = environ.get('SESSION','FileStoreStreamBot')
...
class Config(object):
  ...
  DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://sujanch98:sujanch98@cluster0.tdhcrl5.mongodb.net/?retryWrites=true&w=majority")
  UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL")
  LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1001978535504")
  BANNED_USERS = set(int(x) for x in os.environ.get("BANNED_USERS", "").split())
  FORWARD_AS_COPY = bool(os.environ.get("FORWARD_AS_COPY", True))
  BROADCAST_AS_COPY = bool(os.environ.get("BROADCAST_AS_COPY", True))
  LAZY_CHANNEL = int(os.environ.get('LAZY_CHANNEL', '-1001978535504'))
  ...
  AUTO_DELETE_TIME = int(os.environ.get('AUTO_DELETE_TIME', 45))
  ABOUT_BOT_TEXT = f"""
